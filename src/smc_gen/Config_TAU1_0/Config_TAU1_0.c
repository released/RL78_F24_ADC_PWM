...
void R_Config_TAU1_0_Create(void)
{
    ...
    TT1 |= (_0010_TAU_CH4_STOP_TRG_ON | _0002_TAU_CH1_STOP_TRG_ON | _0001_TAU_CH0_STOP_TRG_ON);
...
void R_Config_TAU1_0_Start(void)
{
    ...
    TOE1 |= (_0010_TAU_CH4_OUTPUT_ENABLE | _0002_TAU_CH1_OUTPUT_ENABLE);
    TS1 |= (_0010_TAU_CH4_START_TRG_ON | _0002_TAU_CH1_START_TRG_ON | _0001_TAU_CH0_START_TRG_ON);
}
...
{
    TT1 |= (_0010_TAU_CH4_STOP_TRG_ON | _0002_TAU_CH1_STOP_TRG_ON | _0001_TAU_CH0_STOP_TRG_ON);
    TOE1 &= (uint16_t)~(_0010_TAU_CH4_OUTPUT_ENABLE | _0002_TAU_CH1_OUTPUT_ENABLE);
    TMMK10 = 1U;    /* disable INTTM10 interrupt */
    TMIF10 = 0U;    /* clear INTTM10 interrupt flag */
    TMMK11 = 1U;    /* disable INTTM11 interrupt */
    TMIF11 = 0U;    /* clear INTTM11 interrupt flag */
